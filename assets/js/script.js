...
$("#freeform").validate({
	...
	messages : {
		...
		subject: "Subject real quick!",
		message: "At least say I miss you Juliano!",
		captcha: "You need to enter the words that appear in image on the left."
	}
});
...
//	e.preventDefault();
	$("#social-networks ul li").removeClass('active');
	$(this).addClass("active");
}
function showTitle(e){
	var title = $(this).data('tips');
	$(this).append("<span class='tooltip'>" + title + " <img src='/assets/images/tooltip-arrow.png' /> </span>");
}
function hideTitle(e){
	$("#social-networks li span.tooltip").remove();
	
}

$(function($){
	$("#social-networks ul li").bind({
		click: changeTab,	
